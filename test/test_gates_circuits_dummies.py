...
def test_construct_circuit():
    H1 = SingleGateCircuit(1, [], "H", ("H", 1), "H1")
    X1 = SingleGateCircuit(1, [], "X", ("H", 1), "X1")
    H2 = SingleGateCircuit(2, [], "H", ("H", 2), "H2")
    X2 = SingleGateCircuit(2, [], "X", ("H", 2), "X2")
...
def test_name_constructed_circuit():
    H1 = SingleGateCircuit(1, [], "H", ("H", 1), "H1")
    X1 = SingleGateCircuit(1, [], "X", ("X", 1), "X1")
    H2 = SingleGateCircuit(2, [], "H", ("H", 2), "H2")
    X2 = SingleGateCircuit(2, [], "X", ("X", 2), "X2")
